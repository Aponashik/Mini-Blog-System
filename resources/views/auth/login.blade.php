              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form  class="user" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                      <input id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Enter Your Password">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{ route('register') }}" target="_blank">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
