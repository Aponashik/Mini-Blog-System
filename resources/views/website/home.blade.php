        ...
        <div class="row align-items-stretch retro-layout-2">
          <div class="col-md-4">
            ...
            @foreach ($firstPosts2 as $post)
              <a href="{{ route('website.post',['slug'=>$post->slug]) }}" class="h-entry mb-30 v-height gradient" style="background: url({{ asset('Post_Image/'.$post->image) }});background-size: cover;">
          ...
          <div class="col-md-4">
            @foreach ($middlePost as $post)
              <a href="{{ route('website.post',['slug'=>$post->slug]) }}" class="h-entry img-5 h-100 gradient" style="background: url({{ asset('Post_Image/'.$post->image) }});background-size: cover">
      ...
      <div class="container">
        ...
        <div class="row">
          @foreach ($recentPosts as $post)
            ...
            <div class="entry2">
              <a href="{{ route('website.post',['slug'=>$post->slug])  }}"><img src="{{ asset('Post_Image/'.$post->image) }}" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
              ...
              <div class="post-meta align-items-center text-left clearfix">
                ...
                <figure class="author-figure mb-0 mr-3 float-left"><img src=" @if($post->user->image){{ asset($post->user->image) }} @else {{ asset('website/images/user.png')}}
        ...
        <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-5 order-md-2">
                <a href="{{ route('website.post', ['slug' => $post->slug]) }}" class="hentry img-1 h-100 gradient"
                    style="background: url({{ asset('Post_Image/'.$post->image) }}); background-size: cover;">
            ...
            <div class="col-md-7">
                ...
                <div class="two-col d-block d-md-flex justify-content-between">
                    ...
                    <a href="{{ route('website.post', ['slug' => $post->slug]) }}"
                        class="hentry v-height img-2 gradient" style="background: url({{ asset('Post_Image/'.$post->image) }}); background-size: cover;">
