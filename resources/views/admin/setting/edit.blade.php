                                ...
                                <div class="card-body">
                                    <form action="{{ route('setting.update') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-8">
                                                  <label for="exampleInputFile">Site Logo</label>
                                                    <input type="file"  name="site_logo"id="exampleInputFile">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="editor" rows="3" class="form-control" placeholder="Enter description">{{ $setting->description }}</textarea>
                                        </div>
                                        <div class="form-group">
